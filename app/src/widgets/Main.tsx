...
export default function Main() {
  return (
    <div className="flex flex-col items-center gap-8 md:flex-row-reverse md:justify-center md:pt-12 md:px-12">
      <picture>
      ...
      <div className="flex flex-col items-center gap-8 md:items-">
        <div className="flex flex-col items-center gap-4 md:items-start md:gap-8">
          <h1 className="text-4xl font-bold md:text-5xl lg:max-w-[360px] lg:text-6xl">Make remote work</h1>
          <p className="px-4 text-this-gray-500 text-center md:px-0 md:w-[300px] md:text-start lg:w-[400px]">
